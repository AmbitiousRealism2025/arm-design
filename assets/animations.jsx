/**
 * animations.jsx - lightweight timeline animation engine.
 *
 * Stage + Sprite pattern, inspired by Remotion but smaller.
 *
 * Exports on window.Animations:
 * - Stage: animation container with time and playback controls
 * - Sprite: time slice shown between start/end, with local progress
 * - useTime(): read global time in seconds
 * - useSprite(): read local progress {t: 0..1, elapsed, duration}
 ...
 *   </Stage>
 *
 * In Sprite children, use useSprite() to read local segment progress.
 */
...
(function() {
  ...
  const Easing = {
    ...
    // expoOut: main premium easing (cubic-bezier(0.16, 1, 0.3, 1)).
    // Fast launch and slow braking give numeric elements physical weight.
