 ...
 *
 * Features:
 *   - Keeps text as vector content where Chromium supports it
 *   - Preserves backgrounds and graphics through Chromium rendering
 *   - Requires no HTML changes
 *   - PDF is the browser print output
 *
 * Tradeoff:
 *   - PDF text is not meant for slide-level editing; edit the HTML source.
 *
